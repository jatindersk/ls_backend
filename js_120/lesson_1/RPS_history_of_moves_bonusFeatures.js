...
//  declare a match variable to keep count of match number
//  declare a game variable to keep count of game number
//  define an object factory function which generates and returns
//  the object of history of moves
//  the object reuturned will include human and comp choices for each
//  match as values in the form of an array while each match count will
//  be saved as the the property key eg: {matchN : [humanChoice, compChoice]}
